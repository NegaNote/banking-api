...
# Target group for banking-service (default)
...
resource "aws_lb_listener" "http" {
  ...
  # Default action: route to banking-service
  default_action {
    type             = "forward"
...
# Route /api/auth/* and /.well-known/* to auth-service
